...
```shell
## install from local
helm upgrade  --create-namespace -n warehouse --install -f /workspaces/data-warehouse/environments/helm/metadata-environment/values.yaml warehouse /tmp/data-warehouse-0.0.16.tgz
