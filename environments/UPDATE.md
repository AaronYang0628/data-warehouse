...
```shell
## install from local
helm upgrade  --create-namespace -n warehouse --install -f /workspaces/data-warehouse/environments/helm/metadata-environment/values.yaml warehouse /tmp/data-warehouse-0.0.15.tgz
# helm upgrade  --create-namespace -n metadata --install -f environments/helm/metadata-environment/values.yaml metadata /tmp/data-warehouse-0.0.15.tgz
